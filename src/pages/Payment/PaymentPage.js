          ...
          <div className="payment-page-wrapper">
            <div className="Wrapper-left">
              <div className="wrapper-infor-payment">
                <div>
                  <span className="payment-lable">Chọn phương thức giao hàng</span>
                  <Radio.Group className="wrapper-radio-payment" onChange={handleDilivery} value={delivery}>
                    <Radio value="fast">
              ...
              <div style={{ width: "100%" }}>
                ...
                <div className="wrapper-total-payment">
                  ...
                  <span className="total-price-wrapper">
                    <span className="total-price-usememo">{convertPrice(totalPriceMemo)}</span>
                    <span className="total-price-vat">(Đã bao gồm VAT nếu có)</span>
                  </span>
                </div>
              </div>
