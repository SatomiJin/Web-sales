        ...
        <div style={{ width: "1270px", margin: "0 auto", height: "1270px" }}>
          ...
          <div className="wrapper-header-user-detail-order">
            <div className="wrapper-info-user-detail-order">
              <div className="wrapper-label-detail-order">Địa chỉ người nhận</div>
            ...
            <div className="wrapper-info-user-detail-order">
              <div className="wrapper-label-detail-order">Hình thức giao hàng</div>
              <div className="wrapper-content-info-detail-order">
            ...
            <div className="wrapper-info-user-detail-order">
              <div className="wrapper-label-detail-order">Hình thức thanh toán</div>
              <div className="wrapper-content-info-detail-order">
          ...
          <div className="wrapper-style-content-detail-order">
            ...
            {data?.orderItems?.map((order) => {
              return (
                <div className="wrapper-product-detail-order">
                  ...
                  <div className="wrapper-item-detail-order">{convertPrice(order?.price)}</div>
                  <div className="wrapper-item-detail-order">{order?.amount}</div>
            ...
            <div className="wrapper-all-price-detail-order">
              ...
              <div className="wrapper-item-detail-order">{convertPrice(priceMemo)}</div>
            </div>
            <div className="wrapper-all-price-detail-order">
              <div className="wrapper-item-label-detail-order">Phí vận chuyển</div>
              <div className="wrapper-item-detail-order">{convertPrice(data?.shippingPrice)}</div>
            </div>
            <div className="wrapper-all-price-detail-order">
              <div className="wrapper-item-label-detail-order">Tổng cộng</div>
              <div className="wrapper-item-detail-order">
                <div className="wrapper-item-detail-order">{convertPrice(data?.totalPrice)}</div>
              </div>
            </div>
          </div>
        </div>
